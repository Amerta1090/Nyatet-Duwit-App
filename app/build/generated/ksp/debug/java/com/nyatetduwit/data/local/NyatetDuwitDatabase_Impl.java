...
import com.nyatetduwit.data.local.dao.ExchangeRateDao_Impl;
...
import com.nyatetduwit.data.local.dao.InvestmentDao_Impl;
...
import com.nyatetduwit.data.local.dao.SplitBillDao_Impl;
...
public final class NyatetDuwitDatabase_Impl extends NyatetDuwitDatabase {
  ...
  protected SupportSQLiteOpenHelper createOpenHelper(@NonNull final DatabaseConfiguration config) {
    final SupportSQLiteOpenHelper.Callback _openCallback = new RoomOpenHelper(config, new RoomOpenHelper.Delegate(7) {
      ...
      public void createAllTables(@NonNull final SupportSQLiteDatabase db) {
        db.execSQL("CREATE TABLE IF NOT EXISTS `accounts` (`id` TEXT NOT NULL, `name` TEXT NOT NULL, `type` TEXT NOT NULL, `balance` INTEGER NOT NULL, `icon` TEXT NOT NULL, `color` TEXT NOT NULL, `currency_code` TEXT NOT NULL, `is_hidden` INTEGER NOT NULL, `order_index` INTEGER NOT NULL, `created_at` INTEGER NOT NULL, `updated_at` INTEGER NOT NULL, `sync_status` TEXT NOT NULL, `last_synced_at` INTEGER, `version` INTEGER NOT NULL, PRIMARY KEY(`id`))");
        ...
        db.execSQL("CREATE TABLE IF NOT EXISTS `transactions` (`id` TEXT NOT NULL, `type` TEXT NOT NULL, `amount` INTEGER NOT NULL, `account_id` TEXT NOT NULL, `category_id` TEXT, `to_account_id` TEXT, `notes` TEXT, `date_time` INTEGER NOT NULL, `created_at` INTEGER NOT NULL, `updated_at` INTEGER NOT NULL, `is_deleted` INTEGER NOT NULL, `deleted_at` INTEGER, `currency_code` TEXT NOT NULL, `exchange_rate` REAL NOT NULL, `attachment_path` TEXT, `sync_status` TEXT NOT NULL, `last_synced_at` INTEGER, `version` INTEGER NOT NULL, PRIMARY KEY(`id`))");
        ...
        db.execSQL("CREATE TABLE IF NOT EXISTS `exchange_rates` (`currency_code` TEXT NOT NULL, `rate_to_base` REAL NOT NULL, `updated_at` INTEGER NOT NULL, PRIMARY KEY(`currency_code`))");
        db.execSQL("CREATE TABLE IF NOT EXISTS `investments` (`id` TEXT NOT NULL, `name` TEXT NOT NULL, `type` TEXT NOT NULL, `current_value` INTEGER NOT NULL, `cost_basis` INTEGER NOT NULL, `currency_code` TEXT NOT NULL, `account_id` TEXT, `notes` TEXT, `is_active` INTEGER NOT NULL, `created_at` INTEGER NOT NULL, `updated_at` INTEGER NOT NULL, PRIMARY KEY(`id`))");
        db.execSQL("CREATE TABLE IF NOT EXISTS `split_bills` (`id` TEXT NOT NULL, `title` TEXT NOT NULL, `total_amount` INTEGER NOT NULL, `paid_by` TEXT NOT NULL, `date` INTEGER NOT NULL, `notes` TEXT, `is_settled` INTEGER NOT NULL, `created_at` INTEGER NOT NULL, `updated_at` INTEGER NOT NULL, PRIMARY KEY(`id`))");
        db.execSQL("CREATE TABLE IF NOT EXISTS `split_bill_persons` (`id` TEXT NOT NULL, `split_bill_id` TEXT NOT NULL, `name` TEXT NOT NULL, `amount` INTEGER NOT NULL, `is_paid` INTEGER NOT NULL, PRIMARY KEY(`id`), FOREIGN KEY(`split_bill_id`) REFERENCES `split_bills`(`id`) ON UPDATE NO ACTION ON DELETE CASCADE )");
        db.execSQL("CREATE INDEX IF NOT EXISTS `index_split_bill_persons_split_bill_id` ON `split_bill_persons` (`split_bill_id`)");
        db.execSQL("CREATE TABLE IF NOT EXISTS room_master_table (id INTEGER PRIMARY KEY,identity_hash TEXT)");
        db.execSQL("INSERT OR REPLACE INTO room_master_table (id,identity_hash) VALUES(42, 'd42ae99ad65bf726350b0c0dcba8eafc')");
      }
      ...
      public void dropAllTables(@NonNull final SupportSQLiteDatabase db) {
        ...
        db.execSQL("DROP TABLE IF EXISTS `split_bill_persons`");
      ...
      public RoomOpenHelper.ValidationResult onValidateSchema(
        ...
        _columnsAccounts.put("currency_code", new TableInfo.Column("currency_code", "TEXT", true, 0, null, TableInfo.CREATED_FROM_ENTITY));
        ...
        _columnsAccounts.put("sync_status", new TableInfo.Column("sync_status", "TEXT", true, 0, null, TableInfo.CREATED_FROM_ENTITY));
        _columnsAccounts.put("last_synced_at", new TableInfo.Column("last_synced_at", "INTEGER", false, 0, null, TableInfo.CREATED_FROM_ENTITY));
        _columnsAccounts.put("version", new TableInfo.Column("version", "INTEGER", true, 0, null, TableInfo.CREATED_FROM_ENTITY));
        ...
        _columnsTransactions.put("exchange_rate", new TableInfo.Column("exchange_rate", "REAL", true, 0, null, TableInfo.CREATED_FROM_ENTITY));
        ...
        _columnsTransactions.put("sync_status", new TableInfo.Column("sync_status", "TEXT", true, 0, null, TableInfo.CREATED_FROM_ENTITY));
        _columnsTransactions.put("last_synced_at", new TableInfo.Column("last_synced_at", "INTEGER", false, 0, null, TableInfo.CREATED_FROM_ENTITY));
        ...
        _columnsExchangeRates.put("currency_code", new TableInfo.Column("currency_code", "TEXT", true, 1, null, TableInfo.CREATED_FROM_ENTITY));
        _columnsExchangeRates.put("rate_to_base", new TableInfo.Column("rate_to_base", "REAL", true, 0, null, TableInfo.CREATED_FROM_ENTITY));
        _columnsExchangeRates.put("updated_at", new TableInfo.Column("updated_at", "INTEGER", true, 0, null, TableInfo.CREATED_FROM_ENTITY));
        ...
        if (!_infoExchangeRates.equals(_existingExchangeRates)) {
          return new RoomOpenHelper.ValidationResult(false, "exchange_rates(com.nyatetduwit.data.local.entity.ExchangeRateEntity).\n"
                  + " Expected:\n" + _infoExchangeRates + "\n"
                  + " Found:\n" + _existingExchangeRates);
        }
        final HashMap<String, TableInfo.Column> _columnsInvestments = new HashMap<String, TableInfo.Column>(11);
        ...
        _columnsInvestments.put("current_value", new TableInfo.Column("current_value", "INTEGER", true, 0, null, TableInfo.CREATED_FROM_ENTITY));
        _columnsInvestments.put("cost_basis", new TableInfo.Column("cost_basis", "INTEGER", true, 0, null, TableInfo.CREATED_FROM_ENTITY));
        _columnsInvestments.put("currency_code", new TableInfo.Column("currency_code", "TEXT", true, 0, null, TableInfo.CREATED_FROM_ENTITY));
        _columnsInvestments.put("account_id", new TableInfo.Column("account_id", "TEXT", false, 0, null, TableInfo.CREATED_FROM_ENTITY));
        _columnsInvestments.put("notes", new TableInfo.Column("notes", "TEXT", false, 0, null, TableInfo.CREATED_FROM_ENTITY));
        _columnsInvestments.put("is_active", new TableInfo.Column("is_active", "INTEGER", true, 0, null, TableInfo.CREATED_FROM_ENTITY));
        _columnsInvestments.put("created_at", new TableInfo.Column("created_at", "INTEGER", true, 0, null, TableInfo.CREATED_FROM_ENTITY));
        _columnsInvestments.put("updated_at", new TableInfo.Column("updated_at", "INTEGER", true, 0, null, TableInfo.CREATED_FROM_ENTITY));
        ...
        if (!_infoInvestments.equals(_existingInvestments)) {
          return new RoomOpenHelper.ValidationResult(false, "investments(com.nyatetduwit.data.local.entity.InvestmentEntity).\n"
                  + " Expected:\n" + _infoInvestments + "\n"
                  + " Found:\n" + _existingInvestments);
        }
        final HashMap<String, TableInfo.Column> _columnsSplitBills = new HashMap<String, TableInfo.Column>(9);
        _columnsSplitBills.put("id", new TableInfo.Column("id", "TEXT", true, 1, null, TableInfo.CREATED_FROM_ENTITY));
        _columnsSplitBills.put("title", new TableInfo.Column("title", "TEXT", true, 0, null, TableInfo.CREATED_FROM_ENTITY));
        _columnsSplitBills.put("total_amount", new TableInfo.Column("total_amount", "INTEGER", true, 0, null, TableInfo.CREATED_FROM_ENTITY));
        _columnsSplitBills.put("paid_by", new TableInfo.Column("paid_by", "TEXT", true, 0, null, TableInfo.CREATED_FROM_ENTITY));
        _columnsSplitBills.put("date", new TableInfo.Column("date", "INTEGER", true, 0, null, TableInfo.CREATED_FROM_ENTITY));
        _columnsSplitBills.put("notes", new TableInfo.Column("notes", "TEXT", false, 0, null, TableInfo.CREATED_FROM_ENTITY));
        ...
        _columnsSplitBills.put("updated_at", new TableInfo.Column("updated_at", "INTEGER", true, 0, null, TableInfo.CREATED_FROM_ENTITY));
        final HashSet<TableInfo.ForeignKey> _foreignKeysSplitBills = new HashSet<TableInfo.ForeignKey>(0);
        final HashSet<TableInfo.Index> _indicesSplitBills = new HashSet<TableInfo.Index>(0);
        ...
        if (!_infoSplitBills.equals(_existingSplitBills)) {
          return new RoomOpenHelper.ValidationResult(false, "split_bills(com.nyatetduwit.data.local.entity.SplitBillEntity).\n"
                  + " Expected:\n" + _infoSplitBills + "\n"
                  + " Found:\n" + _existingSplitBills);
        }
        final HashMap<String, TableInfo.Column> _columnsSplitBillPersons = new HashMap<String, TableInfo.Column>(5);
        _columnsSplitBillPersons.put("id", new TableInfo.Column("id", "TEXT", true, 1, null, TableInfo.CREATED_FROM_ENTITY));
        _columnsSplitBillPersons.put("split_bill_id", new TableInfo.Column("split_bill_id", "TEXT", true, 0, null, TableInfo.CREATED_FROM_ENTITY));
        _columnsSplitBillPersons.put("name", new TableInfo.Column("name", "TEXT", true, 0, null, TableInfo.CREATED_FROM_ENTITY));
        _columnsSplitBillPersons.put("amount", new TableInfo.Column("amount", "INTEGER", true, 0, null, TableInfo.CREATED_FROM_ENTITY));
        _columnsSplitBillPersons.put("is_paid", new TableInfo.Column("is_paid", "INTEGER", true, 0, null, TableInfo.CREATED_FROM_ENTITY));
        final HashSet<TableInfo.ForeignKey> _foreignKeysSplitBillPersons = new HashSet<TableInfo.ForeignKey>(1);
        _foreignKeysSplitBillPersons.add(new TableInfo.ForeignKey("split_bills", "CASCADE", "NO ACTION", Arrays.asList("split_bill_id"), Arrays.asList("id")));
        final HashSet<TableInfo.Index> _indicesSplitBillPersons = new HashSet<TableInfo.Index>(1);
        _indicesSplitBillPersons.add(new TableInfo.Index("index_split_bill_persons_split_bill_id", false, Arrays.asList("split_bill_id"), Arrays.asList("ASC")));
        final TableInfo _infoSplitBillPersons = new TableInfo("split_bill_persons", _columnsSplitBillPersons, _foreignKeysSplitBillPersons, _indicesSplitBillPersons);
        final TableInfo _existingSplitBillPersons = TableInfo.read(db, "split_bill_persons");
        if (!_infoSplitBillPersons.equals(_existingSplitBillPersons)) {
          return new RoomOpenHelper.ValidationResult(false, "split_bill_persons(com.nyatetduwit.data.local.entity.SplitBillPersonEntity).\n"
                  + " Expected:\n" + _infoSplitBillPersons + "\n"
                  + " Found:\n" + _existingSplitBillPersons);
        }
        return new RoomOpenHelper.ValidationResult(true, null);
      }
    }, "d42ae99ad65bf726350b0c0dcba8eafc", "77ae8ef6927d673aa9abfa09a3b8e25d");
  ...
  protected InvalidationTracker createInvalidationTracker() {
    ...
    return new InvalidationTracker(this, _shadowTablesMap, _viewTables, "accounts","categories","transactions","budgets","recurring_transactions","templates","transaction_splits","transaction_tags","goals","debts","debt_payments","exchange_rates","investments","split_bills","split_bill_persons");
  }
  ...
  public void clearAllTables() {
    ...
    try {
      ...
      _db.execSQL("DELETE FROM `split_bill_persons`");
