...
public final class DatabaseModule_ProvideDebtDaoFactory implements Factory<DebtDao> {
  ...
  public DatabaseModule_ProvideDebtDaoFactory(Provider<NyatetDuwitDatabase> databaseProvider) {
  ...
  public static DebtDao provideDebtDao(NyatetDuwitDatabase database) {
