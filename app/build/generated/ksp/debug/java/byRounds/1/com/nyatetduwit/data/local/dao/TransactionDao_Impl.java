...
public final class TransactionDao_Impl implements TransactionDao {
  ...
  public TransactionDao_Impl(@NonNull final RoomDatabase __db) {
    ...
    this.__insertionAdapterOfTransactionEntity = new EntityInsertionAdapter<TransactionEntity>(__db) {
      ...
      protected String createQuery() {
        return "INSERT OR REPLACE INTO `transactions` (`id`,`type`,`amount`,`account_id`,`category_id`,`to_account_id`,`notes`,`date_time`,`created_at`,`updated_at`,`is_deleted`,`deleted_at`,`currency_code`,`exchange_rate`,`attachment_path`,`sync_status`,`last_synced_at`,`version`) VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)";
      }
      ...
      protected void bind(@NonNull final SupportSQLiteStatement statement,
        ...
        statement.bindString(13, entity.getCurrencyCode());
        statement.bindDouble(14, entity.getExchangeRate());
        if (entity.getAttachmentPath() == null) {
          statement.bindNull(15);
        } else {
          statement.bindString(15, entity.getAttachmentPath());
        }
        statement.bindString(16, entity.getSyncStatus());
        if (entity.getLastSyncedAt() == null) {
          statement.bindNull(17);
        } else {
          statement.bindLong(17, entity.getLastSyncedAt());
        }
        statement.bindLong(18, entity.getVersion());
      }
    };
    ...
    this.__updateAdapterOfTransactionEntity = new EntityDeletionOrUpdateAdapter<TransactionEntity>(__db) {
      ...
      @NonNull
      protected String createQuery() {
        return "UPDATE OR ABORT `transactions` SET `id` = ?,`type` = ?,`amount` = ?,`account_id` = ?,`category_id` = ?,`to_account_id` = ?,`notes` = ?,`date_time` = ?,`created_at` = ?,`updated_at` = ?,`is_deleted` = ?,`deleted_at` = ?,`currency_code` = ?,`exchange_rate` = ?,`attachment_path` = ?,`sync_status` = ?,`last_synced_at` = ?,`version` = ? WHERE `id` = ?";
      }
      ...
      public List<TransactionEntity> call() throws Exception {
        ...
        try {
          ...
          while (_cursor.moveToNext()) {
            ...
            _item = new TransactionEntity(_tmpId,_tmpType,_tmpAmount,_tmpAccountId,_tmpCategoryId,_tmpToAccountId,_tmpNotes,_tmpDateTime,_tmpCreatedAt,_tmpUpdatedAt,_tmpIsDeleted,_tmpDeletedAt,_tmpCurrencyCode,_tmpExchangeRate,_tmpAttachmentPath,_tmpSyncStatus,_tmpLastSyncedAt,_tmpVersion);
            _result.add(_item);
          }
          return _result;
        } finally {
      ...
      public TransactionEntity call() throws Exception {
        ...
        try {
          ...
          if (_cursor.moveToFirst()) {
            ...
            final int _tmpVersion;
            _tmpVersion = _cursor.getInt(_cursorIndexOfVersion);
            _result = new TransactionEntity(_tmpId,_tmpType,_tmpAmount,_tmpAccountId,_tmpCategoryId,_tmpToAccountId,_tmpNotes,_tmpDateTime,_tmpCreatedAt,_tmpUpdatedAt,_tmpIsDeleted,_tmpDeletedAt,_tmpCurrencyCode,_tmpExchangeRate,_tmpAttachmentPath,_tmpSyncStatus,_tmpLastSyncedAt,_tmpVersion);
          } else {
            _result = null;
          }
          return _result;
  ...
  public Object getAllTransactionsSync(
    ...
    final String _sql = "SELECT * FROM transactions ORDER BY date_time DESC";
    final RoomSQLiteQuery _statement = RoomSQLiteQuery.acquire(_sql, 0);
    final CancellationSignal _cancellationSignal = DBUtil.createCancellationSignal();
