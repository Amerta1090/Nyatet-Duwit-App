...
import com.nyatetduwit.core.di.DatabaseModule_ProvideInvestmentDaoFactory;
import com.nyatetduwit.core.di.DatabaseModule_ProvideRecurringTransactionDaoFactory;
import com.nyatetduwit.core.di.DatabaseModule_ProvideSplitBillDaoFactory;
...
import com.nyatetduwit.core.worker.SyncWorker_AssistedFactory;
...
import com.nyatetduwit.presentation.investment.InvestmentViewModel;
...
import com.nyatetduwit.presentation.splitbill.SplitBillViewModel;
...
public final class DaggerNyatetDuwitApp_HiltComponents_SingletonC {
  ...
  private static final class ActivityCImpl extends NyatetDuwitApp_HiltComponents.ActivityC {
    ...
    private static final class LazyClassKeyProvider {
      static String com_nyatetduwit_presentation_investment_InvestmentViewModel = "com.nyatetduwit.presentation.investment.InvestmentViewModel";
      ...
      static String com_nyatetduwit_presentation_splitbill_SplitBillViewModel = "com.nyatetduwit.presentation.splitbill.SplitBillViewModel";
      ...
      @KeepFieldType
      InvestmentViewModel com_nyatetduwit_presentation_investment_InvestmentViewModel2;
      ...
      @KeepFieldType
      SplitBillViewModel com_nyatetduwit_presentation_splitbill_SplitBillViewModel2;
  ...
  private static final class ViewModelCImpl extends NyatetDuwitApp_HiltComponents.ViewModelC {
    ...
    private GetActiveInvestmentsUseCase getActiveInvestmentsUseCase() {
      return new GetActiveInvestmentsUseCase(singletonCImpl.bindInvestmentRepositoryProvider.get());
    }

    private GetTotalInvestmentValueUseCase getTotalInvestmentValueUseCase() {
      return new GetTotalInvestmentValueUseCase(singletonCImpl.bindInvestmentRepositoryProvider.get());
    }

    private GetTotalCostBasisUseCase getTotalCostBasisUseCase() {
      return new GetTotalCostBasisUseCase(singletonCImpl.bindInvestmentRepositoryProvider.get());
    }

    private GetInvestmentByIdUseCase getInvestmentByIdUseCase() {
      return new GetInvestmentByIdUseCase(singletonCImpl.bindInvestmentRepositoryProvider.get());
    }

    private AddInvestmentUseCase addInvestmentUseCase() {
      return new AddInvestmentUseCase(singletonCImpl.bindInvestmentRepositoryProvider.get());
    }

    private UpdateInvestmentUseCase updateInvestmentUseCase() {
      return new UpdateInvestmentUseCase(singletonCImpl.bindInvestmentRepositoryProvider.get());
    }

    private DeleteInvestmentUseCase deleteInvestmentUseCase() {
      return new DeleteInvestmentUseCase(singletonCImpl.bindInvestmentRepositoryProvider.get());
    }

    private DeactivateInvestmentUseCase deactivateInvestmentUseCase() {
      return new DeactivateInvestmentUseCase(singletonCImpl.bindInvestmentRepositoryProvider.get());
    }

    private UpdateInvestmentValueUseCase updateInvestmentValueUseCase() {
      return new UpdateInvestmentValueUseCase(singletonCImpl.bindInvestmentRepositoryProvider.get());
    }
    ...
    private GetAllBillsUseCase getAllBillsUseCase() {
      return new GetAllBillsUseCase(singletonCImpl.bindSplitBillRepositoryProvider.get());
    }

    private GetBillByIdUseCase getBillByIdUseCase() {
      return new GetBillByIdUseCase(singletonCImpl.bindSplitBillRepositoryProvider.get());
    }

    private AddBillUseCase addBillUseCase() {
      return new AddBillUseCase(singletonCImpl.bindSplitBillRepositoryProvider.get());
    }

    private UpdateBillUseCase updateBillUseCase() {
      return new UpdateBillUseCase(singletonCImpl.bindSplitBillRepositoryProvider.get());
    }

    private DeleteBillUseCase deleteBillUseCase() {
      return new DeleteBillUseCase(singletonCImpl.bindSplitBillRepositoryProvider.get());
    }

    private MarkSettledUseCase markSettledUseCase() {
      return new MarkSettledUseCase(singletonCImpl.bindSplitBillRepositoryProvider.get());
    }

    private MarkPersonPaidUseCase markPersonPaidUseCase() {
      return new MarkPersonPaidUseCase(singletonCImpl.bindSplitBillRepositoryProvider.get());
    }
    ...
    private void initialize(final SavedStateHandle savedStateHandleParam,
      ...
      this.monthlySummaryViewModelProvider = new SwitchingProvider<>(singletonCImpl, activityRetainedCImpl, viewModelCImpl, 8);
      this.recurringTransactionViewModelProvider = new SwitchingProvider<>(singletonCImpl, activityRetainedCImpl, viewModelCImpl, 9);
      this.reminderSettingsViewModelProvider = new SwitchingProvider<>(singletonCImpl, activityRetainedCImpl, viewModelCImpl, 10);
      this.settingsViewModelProvider = new SwitchingProvider<>(singletonCImpl, activityRetainedCImpl, viewModelCImpl, 11);
      this.splitBillViewModelProvider = new SwitchingProvider<>(singletonCImpl, activityRetainedCImpl, viewModelCImpl, 12);
      this.templateViewModelProvider = new SwitchingProvider<>(singletonCImpl, activityRetainedCImpl, viewModelCImpl, 13);
      this.transactionDetailViewModelProvider = new SwitchingProvider<>(singletonCImpl, activityRetainedCImpl, viewModelCImpl, 14);
      this.transactionListViewModelProvider = new SwitchingProvider<>(singletonCImpl, activityRetainedCImpl, viewModelCImpl, 15);
    ...
    private static final class SwitchingProvider<T> implements Provider<T> {
      ...
      public T get() {
        switch (id) {
          ...
          case 7: // com.nyatetduwit.presentation.investment.InvestmentViewModel 
          return (T) new InvestmentViewModel(viewModelCImpl.getActiveInvestmentsUseCase(), viewModelCImpl.getTotalInvestmentValueUseCase(), viewModelCImpl.getTotalCostBasisUseCase(), viewModelCImpl.getInvestmentByIdUseCase(), viewModelCImpl.addInvestmentUseCase(), viewModelCImpl.updateInvestmentUseCase(), viewModelCImpl.deleteInvestmentUseCase(), viewModelCImpl.deactivateInvestmentUseCase(), viewModelCImpl.updateInvestmentValueUseCase());

          case 8: // com.nyatetduwit.presentation.monthlysummary.MonthlySummaryViewModel 
          ...
          case 9: // com.nyatetduwit.presentation.recurring.RecurringTransactionViewModel 
          ...
          case 10: // com.nyatetduwit.presentation.remindersettings.ReminderSettingsViewModel 
          return (T) new ReminderSettingsViewModel(singletonCImpl.bindSettingsRepositoryProvider.get());

          case 11: // com.nyatetduwit.presentation.settings.SettingsViewModel 
          return (T) new SettingsViewModel(ApplicationContextModule_ProvideContextFactory.provideContext(singletonCImpl.applicationContextModule), singletonCImpl.bindSettingsRepositoryProvider.get(), singletonCImpl.provideExportManagerProvider.get(), viewModelCImpl.pdfExportManager(), singletonCImpl.reminderSchedulerProvider.get(), singletonCImpl.syncManagerProvider.get());

          case 12: // com.nyatetduwit.presentation.splitbill.SplitBillViewModel 
          return (T) new SplitBillViewModel(viewModelCImpl.getAllBillsUseCase(), viewModelCImpl.getBillByIdUseCase(), viewModelCImpl.addBillUseCase(), viewModelCImpl.updateBillUseCase(), viewModelCImpl.deleteBillUseCase(), viewModelCImpl.markSettledUseCase(), viewModelCImpl.markPersonPaidUseCase());

          case 13: // com.nyatetduwit.presentation.template.TemplateViewModel 
          ...
          case 14: // com.nyatetduwit.presentation.transaction.TransactionDetailViewModel 
          ...
          case 15: // com.nyatetduwit.presentation.transaction.TransactionListViewModel 
          ...
          case 16: // com.nyatetduwit.presentation.transaction.TransactionViewModel 
  ...
  private static final class SingletonCImpl extends NyatetDuwitApp_HiltComponents.SingletonC {
    ...
    private Provider<LocalSyncProvider> localSyncProvider;

    private Provider<SyncProvider> bindSyncProvider;
    ...
    private Provider<InvestmentRepositoryImpl> investmentRepositoryImplProvider;
    ...
    private SplitBillDao splitBillDao() {
      return DatabaseModule_ProvideSplitBillDaoFactory.provideSplitBillDao(provideDatabaseProvider.get());
    }
    ...
    private void initialize(final ApplicationContextModule applicationContextModuleParam) {
      ...
      this.localSyncProvider = new SwitchingProvider<>(singletonCImpl, 11);
      this.bindSyncProvider = DoubleCheck.provider((Provider) localSyncProvider);
      this.syncManagerProvider = DoubleCheck.provider(new SwitchingProvider<SyncManager>(singletonCImpl, 10));
      ...
      this.accountRepositoryImplProvider = new SwitchingProvider<>(singletonCImpl, 12);
      this.bindAccountRepositoryProvider = DoubleCheck.provider((Provider) accountRepositoryImplProvider);
      this.budgetRepositoryImplProvider = new SwitchingProvider<>(singletonCImpl, 13);
      this.bindBudgetRepositoryProvider = DoubleCheck.provider((Provider) budgetRepositoryImplProvider);
      this.categoryRepositoryImplProvider = new SwitchingProvider<>(singletonCImpl, 14);
      this.bindCategoryRepositoryProvider = DoubleCheck.provider((Provider) categoryRepositoryImplProvider);
      this.habitTrackerProvider = DoubleCheck.provider(new SwitchingProvider<HabitTracker>(singletonCImpl, 15));
      this.debtRepositoryImplProvider = new SwitchingProvider<>(singletonCImpl, 16);
    ...
    private void initialize2(final ApplicationContextModule applicationContextModuleParam) {
      this.goalRepositoryImplProvider = new SwitchingProvider<>(singletonCImpl, 17);
      this.bindGoalRepositoryProvider = DoubleCheck.provider((Provider) goalRepositoryImplProvider);
      this.investmentRepositoryImplProvider = new SwitchingProvider<>(singletonCImpl, 18);
      this.bindInvestmentRepositoryProvider = DoubleCheck.provider((Provider) investmentRepositoryImplProvider);
      this.reminderSchedulerProvider = DoubleCheck.provider(new SwitchingProvider<ReminderScheduler>(singletonCImpl, 19));
      this.splitBillRepositoryImplProvider = new SwitchingProvider<>(singletonCImpl, 20);
      this.bindSplitBillRepositoryProvider = DoubleCheck.provider((Provider) splitBillRepositoryImplProvider);
      this.templateRepositoryImplProvider = new SwitchingProvider<>(singletonCImpl, 21);
      this.bindTemplateRepositoryProvider = DoubleCheck.provider((Provider) templateRepositoryImplProvider);
      this.transactionSplitRepositoryImplProvider = new SwitchingProvider<>(singletonCImpl, 22);
      this.bindTransactionSplitRepositoryProvider = DoubleCheck.provider((Provider) transactionSplitRepositoryImplProvider);
      this.transactionTagRepositoryImplProvider = new SwitchingProvider<>(singletonCImpl, 23);
    ...
    private static final class SwitchingProvider<T> implements Provider<T> {
      ...
      public T get() {
        switch (id) {
          ...
          case 9: // com.nyatetduwit.core.worker.SyncWorker_AssistedFactory 
          return (T) new SyncWorker_AssistedFactory() {
            @Override
            public SyncWorker create(Context appContext2, WorkerParameters workerParams3) {
              return new SyncWorker(appContext2, workerParams3, singletonCImpl.syncManagerProvider.get());
            }
          };

          case 10: // com.nyatetduwit.core.sync.SyncManager 
          return (T) new SyncManager(singletonCImpl.bindSyncProvider.get());

          case 11: // com.nyatetduwit.core.sync.LocalSyncProvider 
          return (T) new LocalSyncProvider();

          case 12: // com.nyatetduwit.data.repository.AccountRepositoryImpl 
          return (T) new AccountRepositoryImpl(singletonCImpl.accountDao(), singletonCImpl.transactionDao());

          case 13: // com.nyatetduwit.data.repository.BudgetRepositoryImpl 
          return (T) new BudgetRepositoryImpl(singletonCImpl.budgetDao(), singletonCImpl.transactionDao());

          case 14: // com.nyatetduwit.data.repository.CategoryRepositoryImpl 
          return (T) new CategoryRepositoryImpl(singletonCImpl.categoryDao());

          case 15: // com.nyatetduwit.domain.usecase.habit.HabitTracker 
          ...
          case 16: // com.nyatetduwit.data.repository.DebtRepositoryImpl 
          return (T) new DebtRepositoryImpl(singletonCImpl.debtDao());

          case 17: // com.nyatetduwit.data.repository.GoalRepositoryImpl 
          return (T) new GoalRepositoryImpl(singletonCImpl.goalDao());

          case 18: // com.nyatetduwit.data.repository.InvestmentRepositoryImpl 
          return (T) new InvestmentRepositoryImpl(singletonCImpl.investmentDao());

          case 19: // com.nyatetduwit.core.worker.ReminderScheduler 
          return (T) new ReminderScheduler();

          case 20: // com.nyatetduwit.data.repository.SplitBillRepositoryImpl 
          return (T) new SplitBillRepositoryImpl(singletonCImpl.splitBillDao());

          case 21: // com.nyatetduwit.data.repository.TemplateRepositoryImpl 
          return (T) new TemplateRepositoryImpl(singletonCImpl.templateDao(), singletonCImpl.transactionDao());

          case 22: // com.nyatetduwit.data.repository.TransactionSplitRepositoryImpl 
          return (T) new TransactionSplitRepositoryImpl(singletonCImpl.transactionSplitDao());

          case 23: // com.nyatetduwit.data.repository.TransactionTagRepositoryImpl 
