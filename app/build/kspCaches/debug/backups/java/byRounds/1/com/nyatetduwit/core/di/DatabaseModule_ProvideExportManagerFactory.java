...
public final class DatabaseModule_ProvideExportManagerFactory implements Factory<ExportManager> {
  ...
  public ExportManager get() {
    return provideExportManager(transactionDaoProvider.get(), accountDaoProvider.get(), categoryDaoProvider.get(), budgetDaoProvider.get(), recurringTransactionDaoProvider.get(), templateDaoProvider.get());
  }
  ...
  public static DatabaseModule_ProvideExportManagerFactory create(
      ...
      Provider<RecurringTransactionDao> recurringTransactionDaoProvider,
      Provider<TemplateDao> templateDaoProvider) {
    return new DatabaseModule_ProvideExportManagerFactory(transactionDaoProvider, accountDaoProvider, categoryDaoProvider, budgetDaoProvider, recurringTransactionDaoProvider, templateDaoProvider);
  }
  ...
  public static ExportManager provideExportManager(TransactionDao transactionDao,
    ...
    return Preconditions.checkNotNullFromProvides(DatabaseModule.INSTANCE.provideExportManager(transactionDao, accountDao, categoryDao, budgetDao, recurringTransactionDao, templateDao));
  }
}
