  ...
  public AccountDao_Impl(@NonNull final RoomDatabase __db) {
    ...
    this.__insertionAdapterOfAccountEntity = new EntityInsertionAdapter<AccountEntity>(__db) {
      ...
      protected String createQuery() {
        return "INSERT OR REPLACE INTO `accounts` (`id`,`name`,`type`,`balance`,`icon`,`color`,`is_hidden`,`order_index`,`created_at`,`updated_at`) VALUES (?,?,?,?,?,?,?,?,?,?)";
      }
    ...
    this.__updateAdapterOfAccountEntity = new EntityDeletionOrUpdateAdapter<AccountEntity>(__db) {
      ...
      @NonNull
      protected String createQuery() {
        return "UPDATE OR ABORT `accounts` SET `id` = ?,`name` = ?,`type` = ?,`balance` = ?,`icon` = ?,`color` = ?,`is_hidden` = ?,`order_index` = ?,`created_at` = ?,`updated_at` = ? WHERE `id` = ?";
      }
      ...
      public AccountEntity call() throws Exception {
        ...
        try {
          ...
          if (_cursor.moveToFirst()) {
            ...
            final long _tmpUpdatedAt;
            _tmpUpdatedAt = _cursor.getLong(_cursorIndexOfUpdatedAt);
            _result = new AccountEntity(_tmpId,_tmpName,_tmpType,_tmpBalance,_tmpIcon,_tmpColor,_tmpIsHidden,_tmpOrderIndex,_tmpCreatedAt,_tmpUpdatedAt);
          } else {
            _result = null;
          }
          return _result;
